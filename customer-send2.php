...
<html lang="en" dir="ltr">
  <head>
    <meta charset="UTF-8" />
    <title>Transfer Money| Luxura Bank</title>
  ...
  <body>
    ...
    <div class="sidebar">
      ...
      <ul class="nav-links">
        ...
        <li>
          <a href="customer-send2.php" class = "active">
            <i class="bx bx-coin-stack"></i>
            <span class="links_name">Transfer Money</span>
          </a>
        </li>
        <li>
          <a href="#">
...
<div class="form-grid">
    ...
    <h3 class="section-title">Sender's Information</h3>
            <div class="form-group">
...
<div class="form-grid">
            <h3 class="section-title">Recepient's Information</h3>
            <div class="form-group">
...
<div class="buttons">
    ...
    <button class="btn transfer" name="Transfer">Transfer</button>
</div>
