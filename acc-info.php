...
<html lang="en" dir="ltr">
  ...
  <body>
    <form action="acc-info.php" method = "POST"></form>
    <div class="sidebar">
    ...
    <section class="home-section">
      <nav>
        <div class="sidebar-button">
          ...
          <span class="dashboard">Account Setting</span>
        </div>
        <div class="searh-box">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <table>
                    <tbody>
                        <th colspan = "3">
                        <img src="<?php echo htmlspecialchars($userImage); ?>" alt="Profile Image" class = "img" style="width:200px; height: 150px; border-radius: 50%; border: 2px solid black;">
                        </th>
                    <tr>
                            <td>User ID</td>
                            <td>:</td>
                        ...
                        <tr>
                            ...
                            <td>:</td>
                            <td><?php echo htmlspecialchars($acc_no); ?></td>
                        </tr>
                        <tr>
                            <td>Account Type</td>
                            <td>:</td>
                            <td><?php echo htmlspecialchars($acctype); ?></td>
                        </tr>
                            <td>Name</td>
                            <td>:</td>
